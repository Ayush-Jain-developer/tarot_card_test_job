...
const allotment_model_1 = __importDefault(require("@database/models/allotment.model"));
const ratings_model_1 = __importDefault(require("@database/models/ratings.model"));
const product_model_1 = __importDefault(require("@database/models/product.model"));
const paymentMethods_model_1 = __importDefault(require("./paymentMethods.model"));
exports.models = {
    user: user_model_1.default,
    readerBio: reader_bio_model_1.default,
    allotment: allotment_model_1.default,
    ratings: ratings_model_1.default,
    products: product_model_1.default,
    PaymentMethods: paymentMethods_model_1.default,
};
