...
class Messages {
    ...
    static serviceAdded = "New service added successfully";
    static noCards = "No cards saved for the given user";
    static userCards = "Following are the Cards saved for the given user";
}
