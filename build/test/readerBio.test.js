...
describe("Reader bio API", () => {
    test("should return error for no bio", async () => {
        ...
        try {
            const mockReq = {};
            await _service_1.default.updateReaderProfile(mockReq, noBioMockData);
        }
        catch (error) {
    ...
    test("should return error for no specialities", async () => {
        ...
        try {
            const mockReq = {};
            await _service_1.default.updateReaderProfile(mockReq, noSpecialitiesMockData);
        }
        catch (error) {
            expect(fs_1.default.unlinkSync).not.toBeCalled();
            expect(error).toBeInstanceOf(_exceptions_1.BadRequestExceptionError);
    ...
    test("should return error for wrong user role", async () => {
        ...
        try {
            const mockReq = {};
            await _service_1.default.updateReaderProfile(mockReq, mockDataForUpdate);
        }
        catch (error) {
    ...
    test("should return updated reader profile", async () => {
        ...
        const mockReq = {};
        const response = await _service_1.default.updateReaderProfile(mockReq, mockDataForUpdate);
